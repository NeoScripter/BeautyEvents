...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initCarouselControls(
        ...
        const carouselGap = getComputedStyle(container)
            .getPropertyValue('--_carousel-gap')
            .trim()
            .replace('px', '');

        const setSlidePosition = (slide, index) => {
            slide.style.left =
                (slideWidth + parseFloat(carouselGap)) * index + 'px';
        };
    ...
    function initCookiePolicyBtn() {
        ...
        const cookiePolicyAccepted = localStorage.getItem(
